...
public class Sistema {
	...
	public class GM_Particionada {
		...
		// List<Boolean> memoria = new ArrayList<>(1024);
	...
	public class GP {
		//metodo que cria o processo
			//criar o pcb do processo
			//alocar ele na memoria


			//array de processos
		
		int idPCB = 0;
		PCB[] listaPCB = new PCB[0];

		public void criaProcessoPaginada(int tamanhoProcesso) {
			...
			if(conseguiuAlocar) {
				idPCB++;
				PCB pcb = new PCB(tamanhoProcesso, idPCB);

				listaPCB[listaPCB.length] = pcb;
	...
	public class PCB {
		//vai ter as infos do processo (qtd de paginas, se for 01 tanto faz)

		int qtdPaginas = 0;
		int idProcesso;

		public PCB(int qtdPaginas, int idProcesso) {
